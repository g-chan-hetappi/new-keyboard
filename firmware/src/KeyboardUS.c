...
static uint8_t const matrixQwerty[8][12] =
{
    ...
    KEY_LEFT_GUI, KEY_FN, KEY_LEFTCONTROL, KEY_SPACEBAR, KEY_LEFTSHIFT, KEY_LEFTALT, KEY_RIGHTALT, KEY_RIGHTSHIFT, KEY_ENTER, KEY_RIGHTCONTROL, KEY_FN, KEY_RIGHT_GUI
};

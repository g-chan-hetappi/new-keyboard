...
static uint8_t const matrixQwerty[8][12] =
{
    ...
    KEY_Q, KEY_SEMICOLON, KEY_COMMA, KEY_PERIOD, KEY_QUOTE, 0, 0, KEY_Y, KEY_G, KEY_D, KEY_B, KEY_P,
    KEY_A, KEY_O, KEY_E, KEY_U, KEY_I, KEY_ESCAPE, KEY_APPLICATION, KEY_H, KEY_T, KEY_K, KEY_R, KEY_S,
    KEY_Z, KEY_X, KEY_C, KEY_V, KEY_L, KEY_TAB, KEY_BACKSPACE, KEY_N, KEY_M, KEY_J, KEY_F, KEY_W,
    KEY_LEFT_GUI, KEY_FN, KEY_LEFTCONTROL, KEY_SPACEBAR, KEY_LEFTSHIFT, KEY_LEFTALT, KEY_RIGHTALT, KEY_RIGHTSHIFT, KEY_ENTER, KEY_RIGHTCONTROL, KEY_RIGHT_GUI, KEY_FN
};

...
static uint8_t const matrixFn[8][12][3] =
{
    ...
    {{KEY_LEFTALT, KEY_LEFTCONTROL, KEY_DELETE}, {KEY_F1}, {0}, {0}, {0}, {0}, {0}, {0}, {0}, {0}, {KEY_VOLUME_UP}, {KEY_SCROLL_LOCK}},
    ...
    {{KEY_F13}, {KEY_F14}, {KEY_F15}, {KEY_F16}, {KEY_INTERNATIONAL5}, {0}, {0}, {KEY_LEFTCONTROL, KEY_HOME}, {KEY_HOME}, {KEY_UPARROW}, {KEY_END}, {KEY_PAGEUP}},
    {{KEY_F17}, {KEY_F18}, {KEY_F21}, {KEY_F22}, {KEY_INTERNATIONAL4}, {KEY_ESCAPE}, {KEY_CAPS_LOCK}, {KEY_HOME}, {KEY_LEFTARROW}, {KEY_DOWNARROW}, {KEY_RIGHTARROW}, {KEY_PAGEDOWN}},
    {{KEY_LEFTCONTROL, KEY_Z}, {KEY_LEFTCONTROL, KEY_X}, {KEY_LEFTCONTROL, KEY_C}, {KEY_LEFTCONTROL, KEY_V}, {KEY_INTERNATIONAL2}, {KEY_TAB}, {KEY_DELETE}, {KEY_LANG1}, {KEY_LEFTSHIFT, KEY_LEFTARROW}, {KEY_LEFTSHIFT, KEY_DOWNARROW}, {KEY_LEFTSHIFT, KEY_RIGHTARROW}, {KEY_LEFTSHIFT, KEY_END}},
